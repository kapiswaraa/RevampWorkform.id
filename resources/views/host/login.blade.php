                    ...
                    <form action="{{ route('host.login') }}" method="POST">
                        ...
                        <form>
                            ...
                            <div class="mb-6 flex items-center justify-between">
                                ...
                                <a href="{{route('host.forgot')}}" class="text-blue-700">Forgot
                                    password?</a>
                            </div>
                            ...
                            <div class="text-center lg:text-left">
                                ...
                                <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
                                    ...
                                    <a href="{{route('host.register')}}" class="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</a>
                                </p>
                            </div>
                        </form>
                </div>
